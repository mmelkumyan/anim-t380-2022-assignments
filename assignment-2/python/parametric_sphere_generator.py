...
def create_parametric_sphere(radius, resolution):
    """
    ...
    for phi in range(-90, 91, resolution):
        for theta in range(0, 360, resolution):
...
if __name__ == '__main__':
    ...
    parser.add_argument("-resolution", help="Resolution of the sphere.", type=int,
                        default=24)
    args = parser.parse_args()

    create_parametric_sphere(args.radius, args.resolution)
